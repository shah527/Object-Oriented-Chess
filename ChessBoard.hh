...
namespace Student
{
    ...
    public:
         ...
         */
        bool movePiece(int fromRow, int fromColumn, int toRow, int toColumn); // in this class
         ...
         */
        bool isValidMove(int fromRow, int fromColumn, int toRow, int toColumn); // in this class
        ...
        float scoreBoard() const;
        float getHighestNextScore();

    protected:
        ChessPiece *whiteKingLocation;
        ChessPiece *blackKingLocation;
    };
}
